// Using existing mock data from communityPosingLibraryMockData.ts
import { 
  CommunityPose, 
  PoseComment, 
  PhotographerInfo, 
...
export const mockQuery = {
  communityPoses: [
    ...
    } as CommunityPose,
    {
      ...
      portfolio_image_id: 'portfolio-003',
      title: 'Creative Fashion Pose',
      posing_tips: 'Dynamic pose with movement. Have the model walk towards camera while looking over shoulder. Capture mid-stride for natural movement.',
      difficulty_level: DifficultyLevel.ADVANCED,
      people_count: 1,
      category: PoseCategory.FASHION,
      mood_emotion: 'Dynamic, Confident',
      image_url: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=400',
      camera_model: 'Nikon D850',
      lens_model: '70-200mm f/2.8',
      focal_length: 135,
      aperture: 2.8,
      ...
      exif_extraction_success: true,
      manual_override: false,
      additional_equipment: ['Strobe', 'Beauty Dish'],
      lighting_setup: 'Studio strobe with beauty dish',
      location_type: LocationType.STUDIO,
      story_behind: 'Fashion editorial shoot focusing on movement and confidence. The goal was to capture the energy of the model.',
      is_approved: true,
      likes_count: 156,
      views_count: 1890,
      saves_count: 67,
